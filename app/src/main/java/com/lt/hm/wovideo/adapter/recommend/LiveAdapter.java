 ...
 */
public class LiveAdapter extends CommonAdapter<LiveModles.LiveModel> {


    public LiveAdapter(Context context, List<LiveModles.LiveModel> datas, int layoutId) {
        super(context, datas, layoutId);
    }

    @Override
    public void convert(ViewHolder holder, LiveModles.LiveModel liveModel) {
