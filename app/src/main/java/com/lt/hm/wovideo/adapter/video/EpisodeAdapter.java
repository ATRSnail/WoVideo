 ...
 * @create_date 16/9/21
 */
public class EpisodeAdapter extends BaseQuickAdapter<PlaysListBean> {

    public EpisodeAdapter(List<PlaysListBean> data) {
        super(R.layout.layout_video_episode_item, data);
    }

    @Override
    protected void convert(BaseViewHolder baseViewHolder, PlaysListBean playsListBean) {
