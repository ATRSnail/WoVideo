...
// */
//package com.lt.hm.wovideo.screenproject.core;
//
...
//                        @Override
//                        public void run() {
//                            handler.sendEmptyMessage(NewMoviePage.RESUME_SEEKBAR_ACTION);
//                        }
//                    }, 1000);
//                }
//
...
//                    Message msg = Message.obtain(handler, NewMoviePage.GET_MEDIA_INFO_ACTION);
//                    msg.obj = mediaInfo;
//                    msg.sendToTarget();
//                }
//
...
//                    Message msg = Message.obtain(handler, NewMoviePage.GET_POSITION_INFO_ACTION);
...
//                        handler.sendEmptyMessage(NewMoviePage.PLAY_ACTION);
//                    } else if (TransportState.PAUSED_PLAYBACK == ts) {
//                        handler.sendEmptyMessage(NewMoviePage.PAUSE_ACTION);
//                    } else if (TransportState.STOPPED == ts) {
//                        handler.sendEmptyMessage(NewMoviePage.STOP_ACTION);
//                    }
//                }
//
//                @Override
...
//                    Message msg = Message.obtain(handler, NewMoviePage.GET_VOLUME_ACTION, currentVolume, 0);
//                    msg.sendToTarget();
//                }
//
//                @Override
