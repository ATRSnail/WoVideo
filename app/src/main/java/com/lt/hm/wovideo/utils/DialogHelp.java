...
public class DialogHelp {
    ...
    public static IPhoneDialog showDialog(Context context, String message, String negitive_str, DialogInterface.OnClickListener negitive, String positive_str, DialogInterface.OnClickListener positive) {
        IPhoneDialog dialog = new IPhoneDialog(context);
        IPhoneDialog.Builder builder = new IPhoneDialog.Builder(context);
        builder.setMessage(message);
        builder.setNegativeButton(negitive_str,negitive);
