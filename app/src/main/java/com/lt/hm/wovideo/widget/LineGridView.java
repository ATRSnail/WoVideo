...
//        localPaint.setColor(getContext().getResources().getColor(R.color.color_divider_line_gray));
...
//        }
        if (getChildAt(0) != null) {
            ...
            localPaint.setColor(getContext().getResources().getColor(R.color.class_font_color));
