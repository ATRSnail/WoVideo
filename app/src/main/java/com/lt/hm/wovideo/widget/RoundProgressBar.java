...
public class RoundProgressBar extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mRadius = typeArray.getDimension(R.styleable.TasksCompletedView_radius, 60);
        mStrokeWidth = typeArray.getDimension(R.styleable.TasksCompletedView_strokeWidth, 10);
        mCircleColor = typeArray.getColor(R.styleable.TasksCompletedView_circleColor, 0xFFFFFFFF);
        mRingColor = typeArray.getColor(R.styleable.TasksCompletedView_ringColor, 0xFFFF0000);
...
//			canvas.drawCircle(mXCenter, mYCenter, mRadius + mStrokeWidth / 2, mRingPaint);
            ...
            canvas.drawText("跳过", mXCenter - mTxtWidth / 2, mYCenter + mTxtHeight / 4, mTextPaint);
        }
    }
