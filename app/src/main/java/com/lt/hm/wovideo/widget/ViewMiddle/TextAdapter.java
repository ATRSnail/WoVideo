...
public class TextAdapter extends ArrayAdapter<String> {
	...
	public void setDrawLeft(int drawableLeft){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (drawableLeft != 0){
			...
			view.setCompoundDrawablePadding(ScreenUtils.dp2px(mContext,10));
		}

		if (selectedText != null && selectedText.equals(mString)) {
			view.setTextColor(selectedDrawble);//设置选中的背景图片
		} else {
			view.setTextColor(normalDrawbleId);//设置未选中状态背景图片
		}
