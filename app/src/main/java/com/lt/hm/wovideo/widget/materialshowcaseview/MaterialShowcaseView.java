...
import com.lt.hm.wovideo.widget.materialshowcaseview.shape.CircleShape;
import com.lt.hm.wovideo.widget.materialshowcaseview.shape.NoShape;
import com.lt.hm.wovideo.widget.materialshowcaseview.shape.RectangleShape;
import com.lt.hm.wovideo.widget.materialshowcaseview.shape.Shape;
import com.lt.hm.wovideo.widget.materialshowcaseview.target.Target;
import com.lt.hm.wovideo.widget.materialshowcaseview.target.ViewTarget;
...
public class MaterialShowcaseView extends FrameLayout implements View.OnTouchListener, View.OnClickListener {
    ...
    private void setContentTextOnClickListner(OnClickListener listner) {
        if (mContentTextView != null) {
            mContentTextView.setOnClickListener(listner);
        }
    }
    ...
    public static class Builder {
        ...
        public Builder setContentTextOnClick(OnClickListener listener) {
            showcaseView.setContentTextOnClickListner(listener);
            return this;
        }
