 ...
 * a {@link MultiSelector}'s
 * {@link MultiSelector#setSelectable(boolean)}
...
public abstract class ModalMultiSelectorCallback implements ActionMode.Callback {
    ...
    /**
     * <p>Attached {@link MultiSelector} instance.</p>
     *
    ...
    /**
     * <p>Attach this instance to a new {@link MultiSelector}.</p>
     *
