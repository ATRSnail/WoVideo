package com.lt.hm.wovideo.widget.multiselector;
 ...
 * connected instances of {@link SelectableHolder}.</p>
 * <p>The out-of-the-box use of MultiSelector is to team it up with {@link SwappingHolder}
...
public class MultiSelector {
     ...
     * {@link SelectableHolder#setSelectable(boolean)}
     ...
     * {@link SelectableHolder#setActivated(boolean)}
     * for that holder.</p>
     *
     ...
     * <p>Bound holders will receive calls to {@link SelectableHolder#setSelectable(boolean)}
     * and {@link SelectableHolder#setActivated(boolean)} when
